/**
 * 公历转农历工具
 * 基于查表法，支持 1900-2100 年
 */

// 农历数据表（1900-2100）
// 每个元素编码一年的农历信息：
//   bit 0-11: 每月大小月（1=30天，0=29天），bit0=正月
 ...
 * @returns {Object} { year, month, day, isLeap, monthName, dayName, ganZhi, animal }
 */
function solarToLunar(year, month, day) {
  ...
  if (offset < 0) {
    return { year: 1900, month: 1, day: 1, isLeap: false, monthName: '正月', dayName: '初一', ganZhi: '庚子', animal: '鼠' };
  }
