...
const { calcLiuren, getHourName, getHourRange } = require('../../utils/liuren');
...
Page({
  ...
  doDivination() {
    ...
    const result = calcLiuren(lunarMonth, lunarDay, hourIndex);

    this.setData({
      result: {
        monthGod: result.monthGod,
        dayGod: result.dayGod,
        timeGod: result.timeGod,
        lunarMonthStr: lunarInfo.monthName,
        lunarDayStr: lunarInfo.dayName,
        hourStr: getHourName(hourIndex) + '时',
        ganZhi: lunarInfo.ganZhi + '年',
